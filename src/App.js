    ...
    <div className="container">
      <section className="scoreboard">
        <div className="topRow">
          ...
          <div className="timer">00:0{countdown}</div>
          <div className="away">
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button className="homeButtons__fieldGoal" onClick={() => updateHomeScore(homeScore + 4)}>Home Field Goal</button>
        </div>
        <div className="awayButtons">
          <button className="awayButtons__touchdown" onClick={() => updateAwayScore(awayScore + 7)}>Away Touchdown</button>
          <button className="awayButtons__fieldGoal" onClick={() => updateAwayScore(awayScore + 4)}>Away Field Goal</button>
        </div>
      </section>
    </div>
  );
